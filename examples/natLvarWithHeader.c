...
static struct _template__Lattice__pointer__tag_struct_Nat_13__  *_template__newLattice__pointer__tag_struct_Nat_13__(Nat  * least, Nat  * greatest, signed int ( * leq)(), Nat  *( * lub)(), signed int ( * isTop)(), struct _string_s ( * showMethod)())
{
...
struct _template__Lattice__pointer__tag_struct_Nat_13__  *natLattice()
{
  ...
  {
    return ((_template__newLattice__pointer__tag_struct_Nat_13__)(((BotNat)()), ((TopNat)()), (leqNat), (lubNat), (isTopNat), (showNat)));
  }
}
...
struct _template__Lvar__pointer__tag_struct_Nat_13__ {
  ...
  Nat  *_value;
  signed int _frozen;
  struct _template__ThresholdSet__pointer__tag_struct_Nat_13__  *_threshold;
