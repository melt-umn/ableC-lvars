...
signed int main(signed int  argc, char  * * argv)
{
  ...
  {
    struct _template__Lattice__pointer__tag_struct_Nat_13__  *D = ((_template__newLattice__pointer__tag_struct_Nat_13__)(((Bottom)()), ((Top)()), (leq), (lub), (isTop), (showNat)));
