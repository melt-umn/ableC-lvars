...

  {
    signed int result;
    {
      ...
      if (({
        ...
        if (((((*(_curr_scrutinee_ptr)))->tag) != (Nat_Top)))
        {
          ((_match) = 0);
        } else {
      ...
      )
      {
        ...
        if (({
          ...
          /* matching against a ADT constructor pattern */;
          /* match against constructor */;
          if (((((*(_curr_scrutinee_ptr)))->tag) != (Nat_Bottom)))
          {
            ((_match) = 0);
          } else {
            /* match against sub-patterns, setting _match to 0 on a fail */;
...
signed int main(signed int  argc, char  * * argv)
{
  ...
  {
    struct _template__Lattice__pointer__tag_struct_Nat_13__  *D = ((_template__newLattice__pointer__tag_struct_Nat_13__)(((Bottom)()), ((Top)()), (leq), (lub), (eqNat), (showNat)));
