...
typedef signed int _template_param_unused_18;
...
typedef signed int _template_param_unused_22;
...
typedef signed int _template_param_unused_43;
...
typedef signed int _template_param_unused_240;
    ...
    {
      {
        ({
          ...
          ((*(_tmp263)) = ((_append_string)((*(_tmp263)), ((_append_string)(((((act)->_lattice)->_show)((((act)->_set)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((act)->_index)); ((i)++))
    {
      {
        ({
          ...
          ((*(_tmp264)) = ((_append_string)((*(_tmp264)), ((((act)->_lattice)->_show)((((act)->_set)[(i)])))))); })
        ;
      }
    }
...
static struct _string_s _template__showThreshold__builtin_signed_int_(struct _template__ThresholdSet__builtin_signed_int_  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp287 = (&(result));
          ((*(_tmp287)) = ((_append_string)((*(_tmp287)), ((_append_string)(((_template__showActivation__builtin_signed_int_)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp288 = (&(result));
          ((*(_tmp288)) = ((_append_string)((*(_tmp288)), ((_template__showActivation__builtin_signed_int_)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef signed int _template_param_unused_292;
...
typedef signed int _template_param_unused_300;
...
typedef signed int _template_param_unused_304;
...
typedef signed int _template_param_unused_308;
...
typedef signed int _template_param_unused_324;
...
typedef signed int _template_param_unused_328;
...
typedef signed int _template_param_unused_332;
...
signed int main(signed int  argc, char  * * argv)
{

  {
    ...
    struct _template__ActivationSet__builtin_signed_int_  *a = ((_template__addAct__builtin_signed_int_)(((_template__newActivationSet__builtin_signed_int_)((D), 20)), 6));
    struct _template__ThresholdSet__builtin_signed_int_  *t = ((_template__addThreshold__builtin_signed_int_)(((_template__newThresholdSet__builtin_signed_int_)((D), 20)), (a)));
    ((_template__put__builtin_signed_int_)((x), 42));
    ...
    ((free)((D)));
    ((free)((x)));
    ((_template__freeActivation__builtin_signed_int_)((a)));
