...
struct _string_s showArr(signed int  * arr)
{

  {
    ...
    for(; ((i) < ((ARRSIZE) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp45 = (&(result));
          ((*(_tmp45)) = ((_append_string)((*(_tmp45)), ((_append_string)(((showInt)(((arr)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
...
typedef signed int  *_template_param_unused_92;
typedef signed int  *_template_param_unused_96;
...
typedef signed int  *_template_param_unused_100;
...
static void _cilk_putOnes_slow(CilkWorkerState  *const  _cilk_ws, struct _cilk_putOnes_frame  * _cilk_frame)
{
  ...
  ;
  {
    ...
    {
      {
        ...
        ((printf)("k\n"));
        {
          signed int __tmp103 = ((result1) && (result2));
          ((Cilk_set_result)((_cilk_ws), (&(__tmp103)), (sizeof((__tmp103)))));
          /* expand CILK2C_BEFORE_RETURN_SLOW macro */;
          ((Cilk_cilk2c_before_return_slow_cp)((_cilk_ws), (&((_cilk_frame)->header))));
          ((Cilk_cilk2c_before_return_slow)((_cilk_ws), (&((_cilk_frame)->header)), (sizeof((*(_cilk_frame))))));
          return ;
    ...
    {
      signed int __tmp104 = 1;
      ((Cilk_set_result)((_cilk_ws), (&(__tmp104)), (sizeof((__tmp104)))));
      /* expand CILK2C_BEFORE_RETURN_SLOW macro */;
      ((Cilk_cilk2c_before_return_slow_cp)((_cilk_ws), (&((_cilk_frame)->header))));
      ((Cilk_cilk2c_before_return_slow)((_cilk_ws), (&((_cilk_frame)->header)), (sizeof((*(_cilk_frame))))));
      return ;
...
typedef signed int  *_template_param_unused_476;
...
typedef signed int  *_template_param_unused_480;
...
typedef signed int  *_template_param_unused_500;
typedef signed int  *_template_param_unused_504;
...
typedef signed int  *_template_param_unused_508;
...
static struct _string_s _template__showActivation__pointer__builtin_signed_int__(struct _template__ActivationSet__pointer__builtin_signed_int__  * act)
{

  {
    ...
    for(; ((i) < (((act)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp719 = (&(result));
          ((*(_tmp719)) = ((_append_string)((*(_tmp719)), ((_append_string)(((((act)->_lattice)->_show)((((act)->_set)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((act)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp720 = (&(result));
          ((*(_tmp720)) = ((_append_string)((*(_tmp720)), ((((act)->_lattice)->_show)((((act)->_set)[(i)])))))); })
        ;
      }
    }
...
typedef signed int  *_template_param_unused_742;
static struct _string_s _template__showThreshold__pointer__builtin_signed_int__(struct _template__ThresholdSet__pointer__builtin_signed_int__  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp743 = (&(result));
          ((*(_tmp743)) = ((_append_string)((*(_tmp743)), ((_append_string)(((_template__showActivation__pointer__builtin_signed_int__)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp744 = (&(result));
          ((*(_tmp744)) = ((_append_string)((*(_tmp744)), ((_template__showActivation__pointer__builtin_signed_int__)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef signed int  *_template_param_unused_748;
...
typedef signed int  *_template_param_unused_756;
...
typedef signed int  *_template_param_unused_760;
...
typedef signed int  *_template_param_unused_773;
...
static void _cilk_cilk_main_slow(CilkWorkerState  *const  _cilk_ws, struct _cilk_cilk_main_frame  * _cilk_frame)
{
  ...
  ;
  {
    ...
    ((((_cilk_frame)->scope115).result) = (result));
    {
      ...
      {
        ((__tmp761) = (result));
        if (((Cilk_exception_handler)((_cilk_ws), (&(__tmp761)), (sizeof((__tmp761))))))
        {
          ((Cilk_cilk2c_pop)((_cilk_ws)));
          return ;
        } else {
    ...
    {
      signed int __tmp782 = 1;
      ((Cilk_set_result)((_cilk_ws), (&(__tmp782)), (sizeof((__tmp782)))));
      /* expand CILK2C_BEFORE_RETURN_SLOW macro */;
      ((Cilk_cilk2c_before_return_slow_cp)((_cilk_ws), (&((_cilk_frame)->header))));
      ((Cilk_cilk2c_before_return_slow)((_cilk_ws), (&((_cilk_frame)->header)), (sizeof((*(_cilk_frame))))));
      return ;
...
signed int cilk_main(CilkWorkerState  *const  _cilk_ws, signed int  argc, char  * * argv)
{
  ...
  ((Cilk_cilk2c_event_new_thread_maybe)((_cilk_ws)));
  {
    ...
    {
      /* expand CILK2C_XPOP_FRAME_RESULT() macro */;
      signed int __tmp1092;
      if (((Cilk_cilk2c_pop_check)((_cilk_ws))))
      {
        ((__tmp1092) = (result));
        if (((Cilk_exception_handler)((_cilk_ws), (&(__tmp1092)), (sizeof((__tmp1092))))))
        {
          ((Cilk_cilk2c_pop)((_cilk_ws)));
          return 0;
        } else {
