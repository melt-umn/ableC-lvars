...
static struct _template__Lattice__pointer__tag_struct_Color_13__  *_template__newLattice__pointer__tag_struct_Color_13__(Color  * least, Color  * greatest, signed int ( * leq)(), Color  *( * lub)(), signed int ( * isTop)(), struct _string_s ( * showMethod)())
{
...
signed int main(signed int  argc, char  * * argv)
{

  {
    if (((argc) != 3))
    {
      ...
      {
        struct _template__Lattice__pointer__tag_struct_Color_13__  *D = ((_template__newLattice__pointer__tag_struct_Color_13__)(((Bottom)()), ((Top)()), (leqColor), (lubColor), (isTop), (showColor)));
