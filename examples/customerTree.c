...
static void _cilk_cilk_main_slow(CilkWorkerState  *const  _cilk_ws, struct _cilk_cilk_main_frame  * _cilk_frame)
{
  ...
  {
    {
      signed int __tmp48 = 1;
      ((Cilk_set_result)((_cilk_ws), (&(__tmp48)), (sizeof((__tmp48)))));
  ...
  ;
  ;
  ((((_cilk_frame)->scope220).argc) = (argc));
  ((((_cilk_frame)->scope220).argv) = (argv));
  ...
  ;
  ;
  ((argc) = (((_cilk_frame)->scope220).argc));
  ((argv) = (((_cilk_frame)->scope220).argv));
