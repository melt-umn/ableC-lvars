...
typedef struct CustomerSet CustomerSet;
struct CustomerSet {
  unsigned int refId;
  enum _CustomerSet_types {
    CustomerSet_Top,
    CustomerSet_Node,
    CustomerSet_Leaf,
    CustomerSet_Bot
  } tag;
  union _CustomerSet_contents {
    struct CustomerSet_Top_s {
      
    } Top;
    struct CustomerSet_Node_s {
      Bit  *f0;
      CustomerSet  *f1;
      CustomerSet  *f2;
      
    } Node;
    struct CustomerSet_Leaf_s {
      Customer  *f0;
      
    } Leaf;
    struct CustomerSet_Bot_s {
...
static inline CustomerSet  *Top(void)
{

  CustomerSet  *temp;
  ((temp) = ({
    
    ((CustomerSet *)((malloc)((sizeof(CustomerSet))))); })
  );
  (((temp)->tag) = (CustomerSet_Top));
  (((temp)->refId) = 61);
  ;
  ;
  return (temp);
}
static inline CustomerSet  *Node(Bit  * f0, CustomerSet  * f1, CustomerSet  * f2)
{
  ...
  (((temp)->tag) = (CustomerSet_Node));
  (((temp)->refId) = 61);
  ;
  (((((temp)->contents).Node).f0) = (f0));
  (((((temp)->contents).Node).f1) = (f1));
  (((((temp)->contents).Node).f2) = (f2));
  ;
  return (temp);
}
static inline CustomerSet  *Leaf(Customer  * f0)
{
...
static inline CustomerSet  *Bot(void)
{
  ...
  (((temp)->tag) = (CustomerSet_Bot));
  (((temp)->refId) = 61);
  ;
  ;
  return (temp);
}
signed int isTop(CustomerSet  * c)
{

  {
    {
      /* match ((c)) ... */;
      CustomerSet  *_match_scrutinee_val = (c);
      CustomerSet  * *_match_scrutinee_ptr = (&(_match_scrutinee_val));
      /* matching for pattern Top() */;
      /* ... declarations of pattern variables */;
      ;
      CustomerSet  * *_curr_scrutinee_ptr = (_match_scrutinee_ptr);
      if (({
        signed int _match = 1;
        /* matching against a ADT constructor pattern */;
        /* match against constructor */;
        if (((((*(_curr_scrutinee_ptr)))->tag) != (CustomerSet_Top)))
        {
          ((_match) = 0);
        } else {
          /* match against sub-patterns, setting _match to 0 on a fail */;
          CustomerSet  * *_cons_scrutinee_ptr = (_curr_scrutinee_ptr);
          ;
        }
        (_match); })
      )
...
signed int leq(CustomerSet  * c1, CustomerSet  * c2)
{

  {
    {
      /* match ((c1)) ... */;
      CustomerSet  *_match_scrutinee_val = (c1);
      CustomerSet  * *_match_scrutinee_ptr = (&(_match_scrutinee_val));
      /* matching for pattern Top() */;
      /* ... declarations of pattern variables */;
      ;
      ...
      )
      {
        {
          /* match ((c2)) ... */;
          CustomerSet  *_match_scrutinee_val = (c2);
          CustomerSet  * *_match_scrutinee_ptr = (&(_match_scrutinee_val));
          /* matching for pattern Top() */;
          /* ... declarations of pattern variables */;
          ;
        ...
        if (({
          ...
          /* matching against a ADT constructor pattern */;
          /* match against constructor */;
          if (((((*(_curr_scrutinee_ptr)))->tag) != (CustomerSet_Bot)))
          {
            ((_match) = 0);
          } else {
            /* match against sub-patterns, setting _match to 0 on a fail */;
        ...
        )
        {
          ...
          /* matching for pattern Leaf(cust1) */;
          /* ... declarations of pattern variables */;
          Customer  *cust1;
          CustomerSet  * *_curr_scrutinee_ptr = (_match_scrutinee_ptr);
          if (({
            ...
            /* matching against a ADT constructor pattern */;
            /* match against constructor */;
            if (((((*(_curr_scrutinee_ptr)))->tag) != (CustomerSet_Leaf)))
            {
              ((_match) = 0);
            } else {
              /* match against sub-patterns, setting _match to 0 on a fail */;
              CustomerSet  * *_cons_scrutinee_ptr = (_curr_scrutinee_ptr);
              {
                Customer  * *_curr_scrutinee_ptr = (&(((((*(_cons_scrutinee_ptr)))->contents).Leaf).f0));
                ((cust1) = (*(_curr_scrutinee_ptr)));
              }
              ;
            }
            (_match); })
          ...
          {
            {
              ...
              )
              {
                ...
                )
                {
                  ...
                  /* matching for pattern Leaf(cust2) */;
                  /* ... declarations of pattern variables */;
                  Customer  *cust2;
                  CustomerSet  * *_curr_scrutinee_ptr = (_match_scrutinee_ptr);
                  if (({
...
static void _cilk_cilk_main_slow(CilkWorkerState  *const  _cilk_ws, struct _cilk_cilk_main_frame  * _cilk_frame)
{
  ...
  {
    {
      signed int __tmp71 = 1;
      ((Cilk_set_result)((_cilk_ws), (&(__tmp71)), (sizeof((__tmp71)))));
