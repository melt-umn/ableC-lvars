# 1 "translate_error/newActBadSize.xc"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "translate_error/newActBadSize.xc" 2
# 11 "translate_error/newActBadSize.xc"
...
int main (int argc, char **argv) {
  ...
  ActivationSet<State*>* tSet = activationSet(l, 45.6);
  return 0;
}
