# 1 "translate_error/newThreshBadSize.xc"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "translate_error/newThreshBadSize.xc" 2
# 11 "translate_error/newThreshBadSize.xc"
...
int main (int argc, char **argv) {
  ...
  ThresholdSet<State*>* thresh = thresholdSet(l, fSet);
  return 0;
}
