# 1 "translate_error/getBadThresh.xc"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "translate_error/getBadThresh.xc" 2
...
Lattice<Nat*> * natLattice() {
  return lattice(BotNat(), TopNat(), leqNat, lubNat,isTopNat, showNat);
}
# 3 "translate_error/getBadThresh.xc" 2
# 12 "translate_error/getBadThresh.xc"
...
int main (int argc, char **argv) {
  ...
  ThresholdSet<Nat*>* natThresh = thresholdSet(natLat){activationSet(natLat){Int(7)}};
  ...
  ActivationSet<State*>* result1 = get(boolPair1, natThresh);
  return 0;
}
