# 1 "translate_error/invalidLattice.xc"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "translate_error/invalidLattice.xc" 2
# 11 "translate_error/invalidLattice.xc"
...
int main (int argc, char **argv) {
  ...
  Lattice<State*>* l = lattice(Pair(Bot(), Bot()), 5, leq,
                              lub, eq, showState);
