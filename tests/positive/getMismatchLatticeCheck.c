...
signed int main(signed int  argc, char  * * argv)
{

  {
    ...
    struct _template__ActivationSet__pointer__tag_struct_State_20__  *result2 = ((_template__get__pointer__tag_struct_State_20__)((boolPair2), ((_template__addThreshold__pointer__tag_struct_State_20__)(((_template__newThresholdSet__pointer__tag_struct_State_20__)((l2), 20)), (l2Set)))));
    if (((result2) != (((void *)0))))
    {
      {
