...
static struct _string_s _template__showThreshold__pointer__tag_struct_State_20__(struct _template__ThresholdSet__pointer__tag_struct_State_20__  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp246 = (&(result));
          ((*(_tmp246)) = ((_append_string)((*(_tmp246)), ((_append_string)(((_template__showActivation__pointer__tag_struct_State_20__)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp247 = (&(result));
          ((*(_tmp247)) = ((_append_string)((*(_tmp247)), ((_template__showActivation__pointer__tag_struct_State_20__)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef State  *_template_param_unused_251;
...
typedef State  *_template_param_unused_259;
...
typedef State  *_template_param_unused_263;
...
typedef State  *_template_param_unused_264;
