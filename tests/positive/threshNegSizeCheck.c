...
typedef State  *_template_param_unused_598;
typedef State  *_template_param_unused_602;
...
typedef State  *_template_param_unused_610;
...
typedef State  *_template_param_unused_614;
...
typedef State  *_template_param_unused_636;
static struct _string_s _template__showThreshold__pointer__tag_struct_State_37__(struct _template__ThresholdSet__pointer__tag_struct_State_37__  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp637 = (&(result));
          ((*(_tmp637)) = ((_append_string)((*(_tmp637)), ((_append_string)(((_template__showActivation__pointer__tag_struct_State_37__)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp638 = (&(result));
          ((*(_tmp638)) = ((_append_string)((*(_tmp638)), ((_template__showActivation__pointer__tag_struct_State_37__)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef State  *_template_param_unused_646;
...
typedef State  *_template_param_unused_666;
...
typedef State  *_template_param_unused_674;
