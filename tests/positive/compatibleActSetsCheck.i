# 1 "positive/compatibleActSetsCheck.xc"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 174 "../../../extensions/ableC-lvars/include/lvars.xh"
    if (size < 0) {
      size = 0;
    }
...
# 320 "../../../extensions/ableC-lvars/include/lvars.xh"
...
# 409 "../../../extensions/ableC-lvars/include/lvars.xh"
...
# 3 "positive/compatibleActSetsCheck.xc" 2
# 12 "positive/compatibleActSetsCheck.xc"
...
int main (int argc, char **argv) {
  ...
  Lattice<State*>* l2 = lattice(Pair(T(), Bot()), Top(), leq, lub, eq, showState);
  ...
  add(thresh, tSet);
  add(thresh, activationSet(l){Pair(T(), Bot())});
  printf("thresh: %s\n", show(thresh).text);
