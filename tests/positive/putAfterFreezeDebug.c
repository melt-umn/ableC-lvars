...
typedef State  *_template_param_unused_497;
static State  *_template__freeze__pointer__tag_struct_State_41__(struct _template__Lvar__pointer__tag_struct_State_41__  * l)
{

  {
    ((pthread_mutex_lock)((&(((l)->_mutex)))));
    (((l)->_frozen) = 1);
    State  *result = ((l)->_value);
    ((pthread_mutex_unlock)((&(((l)->_mutex)))));
    return (result);
  }
}
signed int main(signed int  argc, char  * * argv)
{

  {
    ...
    ((_template__freeze__pointer__tag_struct_State_41__)((boolPair1)));
