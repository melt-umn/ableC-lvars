...
typedef State  *_template_param_unused_372;
typedef State  *_template_param_unused_376;
...
typedef State  *_template_param_unused_384;
...
typedef State  *_template_param_unused_388;
...
static struct _string_s _template__showThreshold__pointer__tag_struct_State_41__(struct _template__ThresholdSet__pointer__tag_struct_State_41__  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp411 = (&(result));
          ((*(_tmp411)) = ((_append_string)((*(_tmp411)), ((_append_string)(((_template__showActivation__pointer__tag_struct_State_41__)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp412 = (&(result));
          ((*(_tmp412)) = ((_append_string)((*(_tmp412)), ((_template__showActivation__pointer__tag_struct_State_41__)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef State  *_template_param_unused_437;
typedef State  *_template_param_unused_441;
...
typedef State  *_template_param_unused_449;
