...
typedef State  *_template_param_unused_327;
typedef State  *_template_param_unused_331;
...
typedef State  *_template_param_unused_335;
...
typedef State  *_template_param_unused_357;
static struct _string_s _template__showThreshold__pointer__tag_struct_State_20__(struct _template__ThresholdSet__pointer__tag_struct_State_20__  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp358 = (&(result));
          ((*(_tmp358)) = ((_append_string)((*(_tmp358)), ((_append_string)(((_template__showActivation__pointer__tag_struct_State_20__)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp359 = (&(result));
          ((*(_tmp359)) = ((_append_string)((*(_tmp359)), ((_template__showActivation__pointer__tag_struct_State_20__)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef State  *_template_param_unused_360;
...
typedef State  *_template_param_unused_364;
