...
typedef State  *_template_param_unused_348;
...
typedef State  *_template_param_unused_356;
...
static struct _string_s _template__showThreshold__pointer__tag_struct_State_41__(struct _template__ThresholdSet__pointer__tag_struct_State_41__  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp379 = (&(result));
          ((*(_tmp379)) = ((_append_string)((*(_tmp379)), ((_append_string)(((_template__showActivation__pointer__tag_struct_State_41__)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp380 = (&(result));
          ((*(_tmp380)) = ((_append_string)((*(_tmp380)), ((_template__showActivation__pointer__tag_struct_State_41__)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef State  *_template_param_unused_381;
...
typedef State  *_template_param_unused_385;
...
typedef State  *_template_param_unused_389;
...
typedef State  *_template_param_unused_405;
