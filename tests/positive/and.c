...
typedef State  *_template_param_unused_574;
typedef State  *_template_param_unused_578;
...
typedef State  *_template_param_unused_582;
...
typedef State  *_template_param_unused_604;
static struct _string_s _template__showThreshold__pointer__tag_struct_State_37__(struct _template__ThresholdSet__pointer__tag_struct_State_37__  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp605 = (&(result));
          ((*(_tmp605)) = ((_append_string)((*(_tmp605)), ((_append_string)(((_template__showActivation__pointer__tag_struct_State_37__)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp606 = (&(result));
          ((*(_tmp606)) = ((_append_string)((*(_tmp606)), ((_template__showActivation__pointer__tag_struct_State_37__)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef State  *_template_param_unused_630;
typedef State  *_template_param_unused_634;
...
typedef State  *_template_param_unused_638;
