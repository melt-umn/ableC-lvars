...
typedef State  *_template_param_unused_351;
typedef State  *_template_param_unused_355;
...
typedef State  *_template_param_unused_363;
...
typedef State  *_template_param_unused_367;
...
static struct _string_s _template__showThreshold__pointer__tag_struct_State_20__(struct _template__ThresholdSet__pointer__tag_struct_State_20__  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp390 = (&(result));
          ((*(_tmp390)) = ((_append_string)((*(_tmp390)), ((_append_string)(((_template__showActivation__pointer__tag_struct_State_20__)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp391 = (&(result));
          ((*(_tmp391)) = ((_append_string)((*(_tmp391)), ((_template__showActivation__pointer__tag_struct_State_20__)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef State  *_template_param_unused_408;
...
typedef State  *_template_param_unused_416;
