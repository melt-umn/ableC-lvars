...
typedef State  *_template_param_unused_172;
typedef State  *_template_param_unused_176;
...
typedef State  *_template_param_unused_184;
...
typedef State  *_template_param_unused_188;
...
typedef State  *_template_param_unused_210;
static struct _string_s _template__showThreshold__pointer__tag_struct_State_41__(struct _template__ThresholdSet__pointer__tag_struct_State_41__  * t)
{

  {
    ...
    for(; ((i) < (((t)->_index) - 1)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp211 = (&(result));
          ((*(_tmp211)) = ((_append_string)((*(_tmp211)), ((_append_string)(((_template__showActivation__pointer__tag_struct_State_41__)((((t)->_a_sets)[(i)]))), ((strCharPointer)(", "))))))); })
        ;
      }
    }
    for(; ((i) < ((t)->_index)); ((i)++))
    {
      {
        ({
          struct _string_s  *_tmp212 = (&(result));
          ((*(_tmp212)) = ((_append_string)((*(_tmp212)), ((_template__showActivation__pointer__tag_struct_State_41__)((((t)->_a_sets)[(i)])))))); })
        ;
      }
    }
    return ((_append_string)((result), ((strCharPointer)("}"))));
...
typedef State  *_template_param_unused_213;
...
typedef State  *_template_param_unused_217;
...
typedef State  *_template_param_unused_221;
...
typedef State  *_template_param_unused_237;
